...
class _StatisticsScreenState extends State<StatisticsScreen> {
      ...
      body: StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          for (var doc in docs) {
            ...
            // Daily stats (simplified - you can enhance this)
          ...
          double attendanceRate = total > 0 ? (attend / total * 100) : 0;
          double punctualityRate = total > 0 ? (attend / (attend + late) * 100) : 0;
          ...
          return SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                // Overview Card
                _buildOverviewCard(total, attendanceRate, punctualityRate),
                ...
                const SizedBox(height: 16),
                _buildStatusGrid(attend, late, sick, permission, others),
                const SizedBox(height: 24),
                ...
                const SizedBox(height: 16),
                _buildPerformanceCard(attendanceRate, punctualityRate, total),
                const SizedBox(height: 24),
  ...
  Widget _buildOverviewCard(int total, double attendanceRate, double punctualityRate) {
    return Card(
      elevation: 4,
  ...
  Widget _buildStatusGrid(int attend, int late, int sick, int permission, int others) {
  ...
  Widget _buildPerformanceCard(double attendanceRate, double punctualityRate, int total) {
    return Card(
      elevation: 2,
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(16),
